...
from h.model.barriers.chess.poler.agent import ChessAgent, ChessEngineAgent
from h.model.barriers.chess.poler.agent import ChessRandomAgent
...
class Train:
    ...
    def plan(self):
        for shift in [6, 6, 6, 6, 6, 6, 6, 6, 6, 6]: # range(1, 7):
            yield [
                {
